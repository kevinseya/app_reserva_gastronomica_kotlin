...
import com.mespinoza.appgastronomia.ui.screens.events.EventDetailScreen
import com.mespinoza.appgastronomia.ui.screens.events.EventsListScreen
import com.mespinoza.appgastronomia.ui.screens.profile.ProfileScreen
import com.mespinoza.appgastronomia.ui.screens.help.HelpScreen
import com.mespinoza.appgastronomia.ui.screens.about.AboutScreen
import com.mespinoza.appgastronomia.ui.screens.qr.ScanQRScreen
import com.mespinoza.appgastronomia.ui.screens.tables.TablesScreen
import com.mespinoza.appgastronomia.ui.screens.reservations.ReservationsScreen
import com.mespinoza.appgastronomia.ui.screens.tickets.MyTicketsScreen
import com.mespinoza.appgastronomia.ui.screens.tickets.TicketDetailScreen
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable(Screen.Tables.route) {
                TablesScreen(onNavigateToReservations = { navController.navigate(Screen.Reservations.route) })
            }
            ...
            composable(
                ...
                EventDetailScreen(
                    ...
                    ,
                    onNavigateToTableMap = { id ->
                        navController.navigate(Screen.TableMap.createRoute(id))
                    }
                )
            }
            ...
            composable(
                route = Screen.TableMap.route,
                arguments = listOf(navArgument("eventId") { type = NavType.StringType })
            ) { backStackEntry ->
                val eventId = backStackEntry.arguments?.getString("eventId") ?: return@composable
                com.mespinoza.appgastronomia.ui.screens.tables.TableMapScreen(eventId = eventId, onBack = { navController.popBackStack() })
            }

                composable(
                    route = Screen.EventTablesEditor.route,
                    arguments = listOf(navArgument("eventId") { type = NavType.StringType })
                ) { backStackEntry ->
                    val eventId = backStackEntry.arguments?.getString("eventId") ?: return@composable
                    com.mespinoza.appgastronomia.ui.screens.tables.EventTableEditorScreen(eventId = eventId, onNavigateBack = { navController.popBackStack() })
                }
            ...
            if (isAdmin) {
                ...
                composable(Screen.CreateEvent.route) {
                    CreateEventScreen(
                        onNavigateBack = { navController.popBackStack() },
                        onNavigateToTables = { evId -> navController.navigate(com.mespinoza.appgastronomia.navigation.Screen.EventTablesEditor.createRoute(evId)) }
                    )
                }
